...
namespace Music_Store
{
    public partial class About : Page
    {
        ...
        {
            FileInfo fl = new FileInfo("D:\\OneDrive - Espire Infolabs Pvt. Ltd\\Desktop.txt");
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                row[4] = Convert.ToString(txtClassTeacher.Text);
                row[5] = Convert.ToString(txtSection.Text);
            ...
            {
                Response.Write("Decisively Block");
            }
        ...
        protected void txtAdhaar_TextChanged(object sender, EventArgs e)
        {
